# name form keyvault list
# id from keyvault secret list --vault-name  (secret name last field after /)
# id from keyvault secret show --vault-name -n <id>
